...
<head>
    ...
    <style>
        ...
        .page-header { margin-bottom: 2rem; animation: fadeInUp 0.5s ease both; }
        .page-header h1 { font-size: 1.6rem; font-weight: 700; color: #fff; margin: 0; }
        .page-header p { color: #6b7280; margin: 0.25rem 0 0; }
        .card-dark { background: #141414; border: 1px solid #1f1f1f; border-radius: 12px; animation: fadeInUp 0.5s ease 0.1s both; }
        ...
        .form-control, .form-select, input, select, textarea { background: #1f1f1f !important; border: 1px solid #2a2a2a !important; color: #ffffff !important; border-radius: 8px; transition: border-color 0.2s, box-shadow 0.2s; }
        ...
        .btn-danger { background: #dc2626; border: none; border-radius: 8px; padding: 0.75rem 1.5rem; font-weight: 600; font-size: 1rem; transition: all 0.25s; }
        .btn-danger:hover:not(:disabled) { background: #b91c1c; transform: translateY(-2px); box-shadow: 0 6px 24px rgba(220,38,38,0.4); }
        ...
        .info-tip { background: rgba(220,38,38,0.06); border: 1px solid rgba(220,38,38,0.15); border-radius: 8px; padding: 0.75rem 1rem; font-size: 0.82rem; color: #9ca3af; animation: fadeInUp 0.5s ease 0.3s both; }
        ...
        @media (max-width: 480px) {
            .row.g-3 > .col-md-4 { margin-bottom: 0; }
        }
    </style>
</head>
<body>
...
<div class="main-content">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-7">
            <div class="card-dark">
                <div class="card-header-dark"><h5><i class="bi bi-plus-circle me-2 text-danger"></i>New Workout Entry</h5></div>
                <div class="p-4">
                    <% if(exercises.isEmpty()) { %>
                    <div class="no-exercises-warning mb-4"><i class="bi bi-exclamation-triangle me-2"></i>No exercises found. <a href="exercises.jsp" style="color:#fb923c;font-weight:600;">Add exercises first &rarr;</a></div>
                    <% } %>
                    <form action="logWorkout" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="notes" class="form-control" rows="3" placeholder="How did it feel? Any PRs?"></textarea>
                        </div>
            ...
            <div class="info-tip mt-3"><i class="bi bi-lightbulb me-2 text-danger"></i>Tip: Log every session consistently to track your progress over time.</div>
        </div>
    </div>
</div>
