...
<head>
    ...
    <style>
        ...
        .card-dark { background: #141414; border: 1px solid #1f1f1f; border-radius: 12px; animation: fadeInUp 0.5s ease both; }
        ...
        .btn-danger { background: #dc2626; border: none; border-radius: 8px; padding: 0.65rem 1.5rem; font-weight: 600; transition: all 0.25s; }
        ...
        @media (max-width: 768px) {
            ...
            .table tbody td { display: flex; justify-content: space-between; border: none; padding: 0.4rem 0.75rem; }
...
<div class="main-content">
    ...
    <div class="row g-4">
        <div class="col-lg-4">
            <div class="card-dark">
                <div class="card-header-dark"><h5><i class="bi bi-plus-lg me-2 text-danger"></i>Add New Exercise</h5></div>
                <div class="p-4">
                    <form action="addExercise" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="muscle" class="form-select" required>
                                ...
                                <option>Glutes</option><option>Core / Abs</option><option>Calves</option>
                                <option>Full Body</option><option>Cardio</option>
                            </select>
                        </div>
                        <button type="submit" class="btn btn-danger w-100"><i class="bi bi-plus-circle me-2"></i>Add Exercise</button>
                    </form>
                </div>
            </div>
        </div>
        <div class="col-lg-8">
            <div class="card-dark">
                ...
                <div class="empty-state"><i class="bi bi-lightning text-danger"></i><p class="mb-1">No exercises yet</p><small>Add your first exercise using the form</small></div>
                <% } else { %>
                ...
                <table class="table table-borderless">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td data-label="#"><span class="exercise-id">#<%= ex.getId() %></span></td>
                            <td data-label="Name"><strong style="color:#fff"><%= ex.getName() %></strong></td>
                            <td data-label="Muscle"><span class="muscle-badge"><%= ex.getMuscleGroup() %></span></td>
                        </tr>
                        <% } %>
                    </tbody>
                </table>
